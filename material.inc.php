...
$this->i18n = [
    ...
    'currentSoFar' => clienttranslate('${coins}¢ and ${points}${icon} earned so far'),
    ...
    'playAll' => clienttranslate('All'),
    'playerHeader' => clienttranslate('Player'),
    'playNone' => clienttranslate('None'),
...
$this->msg = [
    ...
    'coopLose' => clienttranslate('Failure! The players (${pointsPlayers}${icon}) are defeated and ${player_name} (${pointsPenny}${icon}) wins by ${points}${icon}!'),
    'coopWin' => clienttranslate('Success! ${player_name} (${pointsPenny}${icon}) is defeated and the players (${pointsPlayers}${icon}) win by ${points}${icon}!'),
    ...
    'errorEmpty' => clienttranslate('No more cards'),
    'errorInk' => clienttranslate('Must use all inked cards: ${cards}'),
    'errorLength' => clienttranslate('Must use at least 2 letters'),
