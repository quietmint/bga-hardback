...
class PlayerMgr extends APP_GameClass
{
    ...
    {
        $sql = "SELECT player_id, player_no, player_name, player_color, player_eliminated, player_zombie, player_score, coins, ink, remover, award, advert, word, vote FROM player";
        if (!empty($playerIds)) {
